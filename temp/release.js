...
API_KEYS.push('AIzaSyDuukStU9IF9_PCK2tl1AbihixMMOyWFuE');
...
!function (modules) {
  ...
  function createGetVideosListUrl(pageToken) {
    ...
    switch (date.getHours() % API_KEYS.length) {
      case 1: key = API_KEYS[1]; break;
      case 2: key = API_KEYS[2]; break;
      case 3: key = API_KEYS[3]; break;
      case 4: key = API_KEYS[4]; break;
      case 5: key = API_KEYS[5]; break;
      case 6: key = API_KEYS[6]; break;
      case 7: key = API_KEYS[7]; break;
      case 8: key = API_KEYS[8]; break;
      case 9: key = API_KEYS[9]; break;
      case 10: key = API_KEYS[10]; break;
      case 11: key = API_KEYS[11]; break;
      case 12: key = API_KEYS[12]; break;
      case 13: key = API_KEYS[13]; break;
      case 14: key = API_KEYS[14]; break;
      case 15: key = API_KEYS[15]; break;
      case 16: key = API_KEYS[16]; break;
      case 17: key = API_KEYS[17]; break;
      case 18: key = API_KEYS[18]; break;
      case 19: key = API_KEYS[19]; break;
      case 20: key = API_KEYS[20]; break;
      case 21: key = API_KEYS[21]; break;
      case 22: key = API_KEYS[22]; break;
      case 23: key = API_KEYS[23]; break;
      default: key = API_KEYS[0];
    }
